    ...
    <>
      <div className="bg-[#F2F0F1] flex">
        <div className="max-w-[1240px] mx-auto py-8 sm:py-12 lg:py-[90px] px-4 sm:px-6 flex flex-col gap-6 sm:gap-8 lg:gap-11">
          <div className="max-w-[577px] relative flex flex-col gap-6">
          ...
          <div className="flex flex-wrap sm:flex-row justify-center lg:justify-start gap-4 sm:gap-6 lg:gap-8 mt-8 sm:mt-6">
